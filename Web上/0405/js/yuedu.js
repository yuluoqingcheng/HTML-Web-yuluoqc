...
function showbook(){
	...
	if(books.length){
		...
		for(var i=books.length-1;i>-1;i--){
			...
			bookhtml+='<a href="/shu/'+books[i][0]+'/" class="_17mb_title">'+books[i][2].substring(0,10)+'</a>';
			bookhtml+='<a href="/shu/'+books[i][0]+'/'+books[i][1]+'.html"  class="_17mb_chapter">'+books[i][3].substring(0,18)+'</a>';
